...
#define CMD_NUMBER    8
uint8_t Lora_Cmd_Finish_Buf[8] = {0xA,0xB,0xC,0xD,0x0F,0x01,0x01,0x00};
uint8_t Lora_Cmd_Rotate_Buf[8] = {0xA,0xB,0xC,0xD,0x0F,0x02,0x01,0x00};
uint8_t Lora_Buf[10];
uint8_t *Lora_Cmd_Rotate = Lora_Cmd_Finish_Buf;
uint8_t *Lora_Cmd_Finish = Lora_Cmd_Finish_Buf;
...
void Dev_Lora_SendQuest()
{
   Usart_Send_Data(Lora_Cmd_Finish_Buf, CMD_NUMBER);
